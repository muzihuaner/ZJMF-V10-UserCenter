const coinActive = {
  template: /* html*/ `
  <div class="coin-active-btn">
    <div class="coin-active-trigger" v-show="home_show_coin_activity == 1 || hasPreSales">
      <pre-sales-service @showPreSales="hasPreSales = $event"></pre-sales-service>
      <el-popover placement="left-start" v-model="active_show" trigger="click" popper-class="coin-active-popover"
        ...
        <div slot="reference">
          <div class="inner" role="button" :aria-label="lang.coin_text71 + coin_name">
                  ...
                  <div class="coin-item-detail" v-if="item.show_desc">
                    ...
                    <div class="coin-active-detail">
                      ...
                      <template v-if="item.type === 'total_consume'">
                        ...
                        <p v-if="item.credit_include === 1">{{lang.coin_text102}}：{{lang.coin_text103}}</p>
                        <p>{{lang.coin_text90}}{{coin_name}}{{lang.coin_text91}}：</p>
