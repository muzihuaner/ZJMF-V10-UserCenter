...
<script src="/{$template_catalog}/template/{$public_themes}/components/preSalesService/preSalesService.js"></script>
<script src="/{$template_catalog}/template/{$themes}/components/coinActive/coinActive.js"></script>
<script src="/{$template_catalog}/template/{$themes}/components/clientLevelDialog/clientLevelDialog.js"></script>
