const lang_obj = {
  ...
  /* Unsubscribe */
  common_unsubscribe_pending: "Pending Review",
  common_unsubscribe_suspending: "Pending Unsubscription",
  common_unsubscribe_suspend: "Unsubscribing",
  common_unsubscribe_suspended: "Unsubscribed",
  common_unsubscribe_refund: "Refunded",
  common_unsubscribe_reject: "Review Rejected",
  common_unsubscribe_cancelled: "Cancelled",
  common_unsubscribe_btn_cancel: "Cancel Unsubscription",
  common_unsubscribe_btn_confirm_refund: "Confirm Refund",
  common_unsubscribe_btn_confirm_unsubscribe: "Confirm Unsubscription",
  common_unsubscribe_tip_product: "The product on",
  common_unsubscribe_tip_apply: "Applied",
  common_unsubscribe_tip_expire: "Unsubscribe on Expiry",
  common_unsubscribe_tip_immediate: "Unsubscribe Immediately",
  common_unsubscribe_tip_after_expire: "After Expiry",
  common_unsubscribe_tip_pass: "After 24:00 on the Approval Day",
  common_unsubscribe_tip_auto_delete: "Automatically Deleted",
  common_unsubscribe_tip_at: "At",
  common_unsubscribe_tip_fail: "Failed",
  common_unsubscribe_tip_view_reason: "View Reason",
  common_unsubscribe_title_refund: "Refund",
  common_unsubscribe_title: "Unsubscribe",
  common_unsubscribe_label_product_info: "Product Information",
  common_unsubscribe_label_order_time: "Order Time",
  common_unsubscribe_label_order_amount: "Order Amount",
  common_unsubscribe_label_reason: "Unsubscription Reason",
  common_unsubscribe_label_time: "Unsubscription Time",
  common_unsubscribe_label_immediate: "Immediately",
  common_unsubscribe_label_refund_amount: "Refund Amount",
  common_unsubscribe_msg_cancel_success: "Unsubscription Cancelled Successfully",
  common_unsubscribe_msg_select_reason: "Please Select an Unsubscription Reason",
  common_unsubscribe_msg_select_time: "Please Select an Unsubscription Time",
  common_unsubscribe_tip_no_refund: "This product does not support refunds upon unsubscription. Confirm unsubscription?",
  common_unsubscribe_demand_tip_note: "Notice",
  common_unsubscribe_demand_tip_delete: "The unsubscription operation will permanently delete the instance and release the IP and disk data.",
  common_unsubscribe_demand_tip_backup: "Please ensure that important data has been backed up before proceeding with the unsubscription. Once deleted, the data cannot be recovered.",
  forbid_renew_tip: "This product is forbidden to renew",
  forbid_renew_tip_desc: "This product is forbidden to renew, please contact the administrator for processing",

  /* SSL Certificate */
  ssl_domain_type: "Domain Type",
  ssl_cert_type: "Certificate Type",
  ssl_brand: "Certificate Brand",
  ssl_product_name: "Product Name",
  ssl_product_info: "Product Information",
  ssl_text_single: "Single Domain",
  ssl_text_multi: "Multi-Domain",
  ssl_text_wildcard: "Wildcard",
  ssl_cert: "Certificate",
  ssl_wildcard_count: "Wildcard Count",
  ssl_san_count: "SAN Count",
  ssl_standard_count: "Standard Domain Count",
  ssl_wildcard_domain_count: "Wildcard Domain Count",
  ssl_years: "Subscription Duration",
  ssl_qty: "Quantity",
  ssl_promo_code: "Promo Code",
  ssl_total: "Total",
  buy_now: "Buy Now",
  ssl_config_preview: "Configuration Preview",
  ssl_price: "Base Price (Year)",
  ssl_wildcard_multi: "Wildcard/Multi-Domain",
  ssl_wildcard_multi_yes: "Yes",
  ssl_wildcard_multi_no: "No",
};
