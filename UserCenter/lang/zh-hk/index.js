const lang_obj = {
  ...
  /* 退訂 */
  common_unsubscribe_pending: "待審核",
  common_unsubscribe_suspending: "待退訂",
  common_unsubscribe_suspend: "退訂中",
  common_unsubscribe_suspended: "已退訂",
  common_unsubscribe_refund: "已退款",
  common_unsubscribe_reject: "審核駁回",
  common_unsubscribe_cancelled: "已取消",
  common_unsubscribe_btn_cancel: "取消退訂",
  common_unsubscribe_btn_confirm_refund: "確認退款",
  common_unsubscribe_btn_confirm_unsubscribe: "確認退訂",
  common_unsubscribe_tip_product: "產品於",
  common_unsubscribe_tip_apply: "申請",
  common_unsubscribe_tip_expire: "到期退訂",
  common_unsubscribe_tip_immediate: "立即退訂",
  common_unsubscribe_tip_after_expire: "到期後",
  common_unsubscribe_tip_pass: "通過當天24點後",
  common_unsubscribe_tip_auto_delete: "自動刪除",
  common_unsubscribe_tip_at: "於",
  common_unsubscribe_tip_fail: "失敗",
  common_unsubscribe_tip_view_reason: "查看原因",
  common_unsubscribe_title_refund: "退款",
  common_unsubscribe_title: "退訂",
  common_unsubscribe_label_product_info: "產品資訊",
  common_unsubscribe_label_order_time: "訂購時間",
  common_unsubscribe_label_order_amount: "訂購金額",
  common_unsubscribe_label_reason: "退訂原因",
  common_unsubscribe_label_time: "退訂時間",
  common_unsubscribe_label_immediate: "立即",
  common_unsubscribe_label_refund_amount: "退款金額",
  common_unsubscribe_msg_cancel_success: "取消退訂成功",
  common_unsubscribe_msg_select_reason: "請選擇退訂原因",
  common_unsubscribe_msg_select_time: "請選擇退訂時間",
  common_unsubscribe_tip_no_refund: "此產品退訂不支援退款，確認退訂？",
  common_unsubscribe_demand_tip_note: "注意",
  common_unsubscribe_demand_tip_delete: "退訂操作將永久刪除實例，並釋放IP及硬碟資料。",
  common_unsubscribe_demand_tip_backup: "請確保已備份重要資料後再執行退訂操作，資料一旦刪除將無法恢復。",
  forbid_renew_tip: "此產品已禁止續費",
  forbid_renew_tip_desc: "此產品已禁止續費,如有疑問請聯繫管理員處理",


  /* ssl证书 */
  ssl_domain_type: "域名類型",
  ssl_cert_type: "證書類型",
  ssl_brand: "證書品牌",
  ssl_product_name: "產品名稱",
  ssl_product_info: "產品資訊",
  ssl_text_single: "單域名",
  ssl_text_multi: "多域名",
  ssl_text_wildcard: "通配符",
  ssl_cert: "證書",
  ssl_wildcard_count: "通配符數量",
  ssl_san_count: "多域名數量",
  ssl_standard_count: "標準域名數",
  ssl_wildcard_domain_count: "通配符域名數",
  ssl_years: "訂購時長",
  ssl_qty: "訂購數量",
  ssl_promo_code: "優惠碼",
  ssl_total: "合計",
  buy_now: "立即購買",
  ssl_config_preview: "配置預覽",
  ssl_price: "基础價格（年）",
  ssl_wildcard_multi: "通配符/多域名",
  ssl_wildcard_multi_yes: "是",
  ssl_wildcard_multi_no: "否",
};
